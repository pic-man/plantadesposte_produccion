...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Administrar Proveedores de Hielo</h1>
        </div>
...
<script>
    $(document).ready(function() {
        $('#jtable').DataTable({
            ...
            "ajax": {
            url: "tablas/TablaProveedoresHielo.php",
            type: "post"
            },
            "language": {
    ...
    $('#btnNuevoProveedor').click(function() {
        if (validaciones() == "") {
            ...
            $.ajax({
                ...
                data: {
                    datosProveedorH: datosProveedorP
                },
    ...
    $("#nit").on('change', function() {
        var validarNitProveedorHielo = $("#nit").val();
        if (!$("#nit").val() == "" || !($("#nit").val() == null)) {
            $.ajax({
                type: 'POST',
                url: 'controlador/controlador.php',
                data: {
                    validarNitProveedorHielo
                },
                success: function(data) {
                if (data.length < 5) {
