...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Administrar Proveedores Cerdo</h1>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">
                            <center>
                                <a href="#" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modalNuevoProveedor" title="Agregar Nuevo Proveedor" id="crearProveedor">AGREGAR PROVEEDOR</a>
                            </center>
                            <table id="jtable" class="table table-striped table-bordered table-hover datatable">
                                <thead>
                                    <tr>
                                    <th>Nit<br>siglas</th>
                                    <th>Razon Social<br>&nbsp;</th>
                                    <th>Direccion<br>&nbsp;</th>
                                    <th>Municipio<br>&nbsp;</th>
                                    <th>Status<br>&nbsp;</th>
                                    <th>Acción<br>&nbsp;</th>
    ...
    <div class="modal fade" id="modalNuevoProveedor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="false" style="background-color: #00000042 !important;">
...
<script>
    $(document).ready(function() {
        $('#jtable').DataTable({
            ...
            "ajax": {
            url: "tablas/TablaProveedoresCerdo.php",
            type: "post"
            },
            "language": {
    ...
    $("#nit").on('change', function() {
        var validarNitProveedorCerdo = $("#nit").val();
        if (!$("#nit").val() == "" || !($("#nit").val() == null)) {
            $.ajax({
                type: 'POST',
                url: 'controlador/controlador.php',
                data: {
                    validarNitProveedorCerdo
                },
                success: function(data) {
                if (data.length < 5) {
