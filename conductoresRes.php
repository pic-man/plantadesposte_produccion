...
<body>
 ...
 <?php include_once('menuizquierda.php');?> 
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Administrar Conductores Res</h1>
    </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      var dataTable = $('#jtable').DataTable({
        ...
        "ajax": {
          url: "tablas/TablaConductoresRes.php",
          type: "post"
        },
        "language": {
 ...
 $('#btnNuevoProveedor').click(function() {
    ...
    if (validacionesF == "") {
        ...
        $.ajax({
            ...
            dataType: 'json',
            url: 'controlador/controlador.php',
            data: { datosConductorR: datosConductorD },
		...
		$('#btnEditProveedor').click(function() {
			...
			if (validacionesF == "") {
				...
				console.log('datos enviados: ',infoEditConductorR);
				$.ajax({
					type: 'POST',
					dataType: 'json',
					url: 'controlador/controlador.php',
        ...
        $("#cedula").on('change', function() {
        	...
        	var validarCedulaConductorR = $("#cedula").val();
        	if (!($("#cedula").val() == null || $("#cedula").val() == "")) {
            	console.log("Datos enviados a controlador:", validarCedulaConductorR);
            	$.ajax({
                	type: 'POST',
                	url: 'controlador/controlador.php',
                	data: {
                    	validarCedulaConductorR
                	},
                success: function(data) {
                    if (data.length < 5) {						
						$('#cedulaExiste').val(validarCedulaConductorR);
