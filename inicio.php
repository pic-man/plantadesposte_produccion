...
<head>
  <title>Planta de Desposte | Inicio</title>
      ...
      <div class="row">
        ...
        <div class="col-xxl-4 col-md-6">
          <div class="card info-card sales-card">
            ...
            <div class="card-body">
              <h5 class="card-title">Recepción de Canales</span></h5>

              <div class="d-flex align-items-center">
                <div class="card-icon d-flex align-items-center justify-content-left" style="width: 150px;">
                  Res
                </div>
                <div class="ps-3">
                  <h6>0</h6>
        ...
        <div class="col-xxl-4 col-md-6">
          <div class="card info-card revenue-card">
            ...
            <div class="card-body">
              <h5 class="card-title">Despacho de Canales</span></h5>
