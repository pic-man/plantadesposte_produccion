...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Administrar Proveedores de Salmuera</h1>
        </div>
...
<script>
    $(document).ready(function() {
        $('#jtable').DataTable({
            ...
            "ajax": {
            url: "tablas/TablaProveedoresSalmuera.php",
            type: "post"
            },
            "language": {
    ...
    $('#btnNuevoProveedor').click(function() {
        if (validaciones() == "") {
            ...
            $.ajax({
                ...
                data: {
                    datosProveedorS: datosProveedorP
                },
    ...
    $("#nit").on('change', function() {
        var validarNitProveedorSalmuera = $("#nit").val();
        if (!$("#nit").val() == "" || !($("#nit").val() == null)) {
            $.ajax({
                type: 'POST',
                url: 'controlador/controlador.php',
                data: {
                    validarNitProveedorSalmuera
                },
                success: function(data) {
                if (data.length < 5) {
