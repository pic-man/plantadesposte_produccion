...
$pdf->Cell(25, 5, utf8_decode("No Pollos Desprese: "), 0, 0, '');
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(12, 5, utf8_decode($row[2]), "B", 0, 'C');
$pdf->Cell(2, 5, utf8_decode(""), 0, 0, 'C');
$pdf->Cell(25, 5, utf8_decode("No Pollos Entero: "), 0, 0, '');
$pdf->Cell(12, 5, utf8_decode($row[4]), "B", 0, 'C');
$pdf->Cell(2, 5, utf8_decode(""), 0, 0, 'C');
$pdf->Cell(16, 5, utf8_decode("Tipo Pollo: "), 0, 0, '');
$pdf->Cell(17, 5, utf8_decode($row[29]), "B", 0, 'C');
$pdf->Ln(10);
$pdf->Cell(31, 5, utf8_decode("Peso Inicial Desprese: "), 0, 0, '');
$pdf->Cell(17, 5, utf8_decode($row[3]), "B", 0, 'C');
$pdf->Cell(2, 5, utf8_decode(""), 0, 0, 'C');
$pdf->Cell(28, 5, utf8_decode("Peso Inicial Entero: "), 0, 0, '');
$pdf->Cell(16, 5, utf8_decode($row[5]), "B", 0, 'C');
$pdf->Cell(2, 5, utf8_decode(""), 0, 0, 'C');
...
$pdf->Cell(5, 8, "", 0, 0, 'C');
$pdf->Cell(49, 8, "", 1, 0, 'C');
$pdf->Cell(65.3, 4, utf8_decode("Peso por Desprese"), 1, 0, 'C');
$pdf->Cell(5, 4, "", 0, 0, 'C');
$pdf->Cell(60.7, 4, utf8_decode("Peso Producto con Proceso"), 1, 1, 'C');
$pdf->Cell(54, 8, "", 0, 0, 'C');
$pdf->Cell(65.3, 4, utf8_decode("TOTAL"), 1, 0, 'C');
$pdf->Cell(5, 4, "", 0, 0, 'C');
$pdf->Cell(60.7, 4, utf8_decode("TOTAL PROCESADO"), 1, 1, 'C');
$pdf->Cell(5, 8, "", 0, 0, 'C');
$pdf->Cell(49, 8, utf8_decode("Item       Descripción"), 1, 0, '');
$pdf->Cell(20, 8, utf8_decode("Lote Planta"), 1, 0, 'C');
$pdf->Cell(15.1, 8, utf8_decode("Unids"), 1, 0, 'C');
$pdf->Cell(15.1, 8, utf8_decode("Kilos"), 1, 0, 'C');
$pdf->Cell(15.1, 8, utf8_decode("Cajas"), 1, 0, 'C');
$pdf->Cell(5, 4, "", 0, 0, 'C');
$pdf->Cell(20.2, 8, utf8_decode("Unids"), 1, 0, 'C');
$pdf->Cell(20.2, 8, utf8_decode("Kilos"), 1, 0, 'C');
$pdf->Cell(20.3, 8, utf8_decode("Cajas"), 1, 1, 'C');
$pdf->SetFont('Arial', '', 8);
if ($items["059762"]["kg"] != 0) {
    ...
    $pdf->Cell(15.1, 10, $nrPollos, 1, 0, 'C');
    $pdf->Cell(15.1, 10, $items["059762"]["kg"], 1, 0, 'C');
    $pdf->Cell(15.1, 10, $items["059762"]["cajas"], 1, 0, 'C');
    $pdf->Cell(5, 4, "", 0, 0, 'C');
    $pdf->Cell(20.2, 10, $nrPollos, 1, 0, 'C');
    $pdf->Cell(20.2, 10, $itemsM["059762"]["kg"], 1, 0, 'C');
    $pdf->Cell(20.3, 10, $itemsM["059762"]["cajas"], 1, 1, 'C');
}else {
    $espacios += 10;
}
if ($items["059760"]["kg"] != 0) {
    ...
    $pdf->Cell(15.1, 10, $nrPollos, 1, 0, 'C');
    $pdf->Cell(15.1, 10, $items["059760"]["kg"], 1, 0, 'C');
    $pdf->Cell(15.1, 10, $items["059760"]["cajas"], 1, 0, 'C');
    $pdf->Cell(5, 4, "", 0, 0, 'C');
    $pdf->Cell(20.2, 10, $nrPollos, 1, 0, 'C');
    $pdf->Cell(20.2, 10, $itemsM["059760"]["kg"], 1, 0, 'C');
    $pdf->Cell(20.3, 10, $itemsM["059760"]["cajas"], 1, 1, 'C');
}else {
    $espacios += 10;
}
if ($items["059761"]["kg"] != 0) {
    ...
    $pdf->Cell(15.1, 10, $nrPollos * 2, 1, 0, 'C');
    $pdf->Cell(15.1, 10, $items["059761"]["kg"], 1, 0, 'C');
    $pdf->Cell(15.1, 10, $items["059761"]["cajas"], 1, 0, 'C');
    $pdf->Cell(5, 4, "", 0, 0, 'C');
    $pdf->Cell(20.2, 10, $nrPollos * 2, 1, 0, 'C');
    $pdf->Cell(20.2, 10, $itemsM["059761"]["kg"], 1, 0, 'C');
    $pdf->Cell(20.3, 10, $itemsM["059761"]["cajas"], 1, 1, 'C');
}else {
    $espacios += 10;
}
if ($items["059759"]["kg"]) {
    ...
    $pdf->Cell(15.1, 10, $nrPollos, 1, 0, 'C');
    $pdf->Cell(15.1, 10, $items["059759"]["kg"], 1, 0, 'C');
    $pdf->Cell(15.1, 10, $items["059759"]["cajas"], 1, 0, 'C');
    $pdf->Cell(5, 4, "", 0, 0, 'C');
    $pdf->Cell(20.2, 10, $nrPollos, 1, 0, 'C');
    $pdf->Cell(20.2, 10, $itemsM["059759"]["kg"], 1, 0, 'C');
    $pdf->Cell(20.3, 10, $itemsM["059759"]["cajas"], 1, 1, 'C');
}else {
    $espacios += 10;
}
if ($items["059758"]["kg"] != 0) {
    ...
    $pdf->Cell(15.1, 10, $nrPollos, 1, 0, 'C');
    $pdf->Cell(15.1, 10, $items["059758"]["kg"], 1, 0, 'C');
    $pdf->Cell(15.1, 10, $items["059758"]["cajas"], 1, 0, 'C');
    $pdf->Cell(5, 4, "", 0, 0, 'C');
    $pdf->Cell(20.2, 10, $nrPollos, 1, 0, 'C');
    $pdf->Cell(20.2, 10, $itemsM["059758"]["kg"], 1, 0, 'C');
    $pdf->Cell(20.3, 10, $itemsM["059758"]["cajas"], 1, 1, 'C');
}else {
    $espacios += 10;
}
if ($items["059756"]["kg"] != 0) {
    ...
    $pdf->Cell(15.1, 10, $nrPollos, 1, 0, 'C');
    $pdf->Cell(15.1, 10, $items["059756"]["kg"], 1, 0, 'C');
    $pdf->Cell(15.1, 10, $items["059756"]["cajas"], 1, 0, 'C');
    $pdf->Cell(5, 4, "", 0, 0, 'C');
    $pdf->Cell(20.2, 10, $nrPollos, 1, 0, 'C');
    $pdf->Cell(20.2, 10, $itemsM["059756"]["kg"], 1, 0, 'C');
    $pdf->Cell(20.3, 10, $itemsM["059756"]["cajas"], 1, 1, 'C');
}else {
    $espacios += 10;
}
if ($items["059757"]["kg"] != 0) {
    ...
    $pdf->Cell(15.1, 10, $nrPollos * 2, 1, 0, 'C');
    $pdf->Cell(15.1, 10, $items["059757"]["kg"], 1, 0, 'C');
    $pdf->Cell(15.1, 10, $items["059757"]["cajas"], 1, 0, 'C');
    $pdf->Cell(5, 4, "", 0, 0, 'C');
    $pdf->Cell(20.2, 10, $nrPollos * 2, 1, 0, 'C');
    $pdf->Cell(20.2, 10, $itemsM["059757"]["kg"], 1, 0, 'C');
    $pdf->Cell(20.3, 10, $itemsM["059757"]["cajas"], 1, 1, 'C');
}else {
    $espacios += 10;
}
if ($items["059755"]["kg"] != 0) {
    ...
    $pdf->Cell(15.1, 10, $nrPollos, 1, 0, 'C');
    $pdf->Cell(15.1, 10, $items["059755"]["kg"], 1, 0, 'C');
    $pdf->Cell(15.1, 10, $items["059755"]["cajas"], 1, 0, 'C');
    $pdf->Cell(5, 4, "", 0, 0, 'C');
    $pdf->Cell(20.2, 10, $nrPollos, 1, 0, 'C');
    $pdf->Cell(20.2, 10, $itemsM["059755"]["kg"], 1, 0, 'C');
    $pdf->Cell(20.3, 10, $itemsM["059755"]["cajas"], 1, 1, 'C');
}else {
    $espacios += 10;
}
if ($items["042788"]["kg"] != 0) {
    ...
    $pdf->Cell(15.1, 10, "", 1, 0, 'C');
    $pdf->Cell(15.1, 10, $items["042788"]["kg"], 1, 0, 'C');
    $pdf->Cell(15.1, 10, $items["042788"]["cajas"], 1, 0, 'C');
    $pdf->Cell(5, 4, "", 0, 0, 'C');
    $pdf->Cell(20.2, 10, "", 1, 0, 'C');
    $pdf->Cell(20.2, 10, $itemsM["042788"]["kg"], 1, 0, 'C');
    $pdf->Cell(20.3, 10, $itemsM["042788"]["cajas"], 1, 1, 'C');
}else {
    $espacios += 10;
}
if ($items["042789"]["kg"] != 0) {
    ...
    $pdf->Cell(15.1, 10, "", 1, 0, 'C');
    $pdf->Cell(15.1, 10, $items["042789"]["kg"], 1, 0, 'C');
    $pdf->Cell(15.1, 10, $items["042789"]["cajas"], 1, 0, 'C');
    $pdf->Cell(5, 4, "", 0, 0, 'C');
    $pdf->Cell(20.2, 10, "", 1, 0, 'C');
    $pdf->Cell(20.2, 10, $itemsM["042789"]["kg"], 1, 0, 'C');
    $pdf->Cell(20.3, 10, $itemsM["042789"]["cajas"], 1, 1, 'C');
}else {
    $espacios += 10;
}
if ($items["045401"]["kg"]) {
    ...
    $pdf->SetXY($pdf->GetX() + 16, $pdf->GetY() + 1);
    ...
    $pdf->Cell(15.1, 14, "", 1, 0, 'C');
    $pdf->Cell(15.1, 14, $items["045401"]["kg"], 1, 0, 'C');
    $pdf->Cell(15.1, 14, $items["045401"]["cajas"], 1, 0, 'C');
    $pdf->Cell(5, 4, "", 0, 0, 'C');
    $pdf->Cell(20.2, 14, "", 1, 0, 'C');
    $pdf->Cell(20.2, 14, $itemsM["045401"]["kg"], 1, 0, 'C');
    $pdf->Cell(20.3, 14, $itemsM["045401"]["cajas"], 1, 1, 'C');
}else {
    $espacios += 16;
}
$pdf->Ln(2);
$pdf->Cell(5, 8, "", 0, 0, 'C');
$pdf->Cell(180, 28, "", 1, 1, 'C');
$pdf->SetXY($pdf->GetX() + 5, $pdf->GetY() - 28);
$pdf->Cell(47, 7, "SUBTOTAL POLLO DESPRESADO", 0, 0, 'C');
$pdf->Cell(37.1, 7, "", 0, 0, 'C');
$pdf->Cell(15.1, 7, $PesoTotalDes, 0, 0, 'C');
$pdf->Cell(15.1, 7, $CajaTotalDes, 0, 0, 'C');
$pdf->Cell(25.2, 7, "", 0, 0, 'C');
$pdf->Cell(20.2, 7, $PesoTotalMej, 0, 0, 'C');
$pdf->Cell(20.2, 7, $CajaTotalMej, 0, 1, 'C');
$pdf->Cell(5, 8, "", 0, 0, 'C');
$pdf->Cell(21, 7, "TOTAL BRUTO", 0, 0, 'C');
$pdf->Cell(63.1, 7, "", 0, 0, 'C');
$pdf->Cell(15.1, 7, $PesoTotalDesP, 0, 0, 'C');
$pdf->Cell(15.1, 7, $CajaTotalDesP, 0, 0, 'C');
$pdf->Cell(25.2, 7, "", 0, 0, 'C');
$pdf->Cell(20.2, 7, $PesoTotalMejP, 0, 0, 'C');
$pdf->Cell(20.2, 7, $CajaTotalMejP, 0, 1, 'C');
$pdf->Cell(5, 8, "", 0, 0, 'C');
$pdf->Cell(21, 7, "CANASTILLAS", 0, 0, 'C');
$pdf->Cell(48, 7, "", 0, 0, 'C');
$pdf->Cell(15.1, 7, $canastillasBase, 0, 0, 'C');
$pdf->Cell(15.1, 7, number_format(($canastillasBase * 1.8), 2), 0, 1, 'C');
$pdf->Cell(5, 8, "", 0, 0, 'C');
$pdf->Cell(84.1, 7, "", 0, 0, 'C');
$pdf->Cell(15.1, 7, number_format($PesoTotalDesP - ($canastillasBase * 1.8), 2), 0, 1, 'C');
$pdf->Ln(5);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(15, 5, "", 0, 0, 'C');
...
$pdf->Cell(5, 5, "", 0, 0, 'C');
$pdf->Cell(23, 5, "Pollo", 1, 0, 'L');
$pdf->Cell(38, 5, substr(utf8_decode($row[6]), 0, 19)  , 1, 0, 'C');
$pdf->Cell(25, 5, utf8_decode($row[7]), 1, 0, 'C');
$pdf->Cell(18, 5, utf8_decode($row[8]), 1, 0, 'C');
$pdf->Ln(5);
...
$pdf->Cell(38, 5, utf8_decode($row[9]) , 1, 0, 'C');
$pdf->Cell(25, 5, utf8_decode($row[10]), 1, 0, 'C');
$pdf->Cell(18, 5, utf8_decode($row[11]), 1, 0, 'C');
$pdf->Ln(5);
$pdf->Cell(12, 13, "", 1, 0, '');
...
$pdf->Cell(38, 5, utf8_decode($row[12]) , 1, 0, 'C');
...
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(38, 5, utf8_decode($row[15]) , 1, 0, 'C');
$pdf->Cell(25, 5, "", 1, 0, 'C');
$pdf->Cell(18, 5, "N/A", 1, 1, 'C');
$pdf->SetFont('Arial', '', 8);
$pdf->SetXY($pdf->GetX() + 85, $pdf->GetY());
$pdf->Cell(23, 5, "Salmuera", 1, 0, 'L');
$pdf->Cell(38, 5, utf8_decode($row[16]) , 1, 0, 'C');
$pdf->Cell(25, 5, utf8_decode($row[17]), 1, 0, 'C');
$pdf->Cell(18, 5, utf8_decode($row[18]), 1, 1, 'C');
$pdf->SetXY($pdf->GetX() + 146, $pdf->GetY());
$pdf->Cell(43, 5, "Concentracion Samuera: " . $row[30] . "%", 0, 0, 'C');
$pdf->Ln(20);
...
$firma = "../assets/img/firmas/".$row[19].".jpg";
$pdf->Image($firma, 49.7, 286 - $espacios, 31.5, 9.7);
$pdf->Cell(18, 5, "", 0, 0, 'C');
...
$pdf->Cell(15, 5, $row[25], 1, 0, 'C');
$pdf->Cell(5, 5, "", 0, 0, 'C');
$pdf->Cell(10, 5, "Hora", 1, 0, 'C');
$pdf->Cell(15, 5, $row[26], 1, 0, 'C');
$pdf->Cell(5, 5, "", 0, 0, 'C');
$pdf->Cell(10, 5, "Hora", 1, 0, 'C');
$pdf->Cell(15, 5, $row[27], 1, 0, 'C');
$pdf->Cell(5, 5, "", 0, 1, 'C');
$pdf->Cell(104, 5, "", 0, 0, 'C');
$pdf->SetFont('Arial', '', 7);
$pdf->Cell(10, 5, utf8_decode("Temp °C"), 1, 0, 'C');
if (!empty($row[22])) {
    $pdf->Cell(15, 5, utf8_decode($row[22] . "°"), 1, 0, 'C');
}else {
    $pdf->Cell(15, 5, "", 1, 0, 'C');
}
$pdf->Cell(5, 5, "", 0, 0, 'C');
$pdf->Cell(10, 5, utf8_decode("Temp °C"), 1, 0, 'C');
if (!empty($row[23])) {
    $pdf->Cell(15, 5, utf8_decode($row[23] . "°"), 1, 0, 'C');
}else {
    $pdf->Cell(15, 5, "", 1, 0, 'C');
}
$pdf->Cell(5, 5, "", 0, 0, 'C');
$pdf->Cell(10, 5, utf8_decode("Temp °C"), 1, 0, 'C');
$pdf->Cell(15, 5, utf8_decode($row[24] . "°"), 1, 0, 'C');
$pdf->Cell(5, 5, "", 0, 1, 'C');
$pdf->Ln(2);
$pdf->Cell(26.7, 5, "", 0, 0, 'C');
$pdf->SetFont('Arial', 'B', 8);
$pdf->SetXY($pdf->GetX(), $pdf->GetY() + 19);
$pdf->Cell(55, 5, utf8_decode($row[20]), 0, 1, 'C');
$pdf->Cell(26.7, 5, "", 0, 0, 'C');
$pdf->Cell(55, 5, "Responsable de Desprese", 0, 0, 'C');
$pdf->SetFont('Arial', '', 8);
...
$pdf->Image($firma, 130, 286 - $espacios, 31.5, 9.7);
